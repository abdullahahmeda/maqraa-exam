...
import { ExamQuestionAvgAggregateInputObjectSchema } from './objects/ExamQuestionAvgAggregateInput.schema'
import { ExamQuestionSumAggregateInputObjectSchema } from './objects/ExamQuestionSumAggregateInput.schema'
...
export const ExamQuestionSchema = {
  ...
  aggregate: z.object({
    ...
    _avg: ExamQuestionAvgAggregateInputObjectSchema.optional(),
    _sum: ExamQuestionSumAggregateInputObjectSchema.optional(),
  }),
  groupBy: z.object({
    where: ExamQuestionWhereInputObjectSchema.optional(),
    orderBy: z.union([
