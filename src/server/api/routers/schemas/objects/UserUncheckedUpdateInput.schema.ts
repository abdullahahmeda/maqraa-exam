...
import { ExamUncheckedUpdateManyWithoutUserNestedInputObjectSchema } from './ExamUncheckedUpdateManyWithoutUserNestedInput.schema'
...
> = z
  .object({
    ...
    sessions: z
      ...
      .optional(),
    exams: z
      .lazy(() => ExamUncheckedUpdateManyWithoutUserNestedInputObjectSchema)
      .optional(),
  })
  .strict()
